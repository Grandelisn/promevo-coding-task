...
function AddLabelForm() {
  ...
  return (
    <Container component="form" onSubmit={handleSubmit(onSubmit)} sx={{display: 'flex', flexDirection: 'column', gap: 2}}>
      <TextField
        ...
        <SelectField 
          ...
          options={labelColorValues.map((color) => ({ value: color, label: color }))}
          label="Text Color"
        />
        <SelectField 
